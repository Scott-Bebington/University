...
void Plane::CreatePlane()
{
    ...
    Shape *aileronCenter = new Box(vec3(0.1835, 0.05825, 0), 0.15, 0.05, 0.02, brown);
...
void Plane::turnPropeller()
{
    cout << "Turning propeller" << endl;
    cout << "Current X rotation angle: " << this->currentXRot << endl;
    cout << "Current Y rotation angle: " << this->currentYRot << endl;
    cout << "Current Z rotation angle: " << this->currentZRot << endl;

    float tempX = this->currentXRot;
    float tempY = this->currentYRot;
    float tempZ = this->currentZRot;
    ...
    // rotationY[0].x = cos(-this->currentYRot);
    // rotationY[0].z = -sin(-this->currentYRot);
    // rotationY[1].y = 1;
    // rotationY[2].x = sin(-this->currentYRot);
    // rotationY[2].z = cos(-this->currentYRot);
    // rotationY[3].w = 1;

    // mat4x4 rotationZ = mat4x4(0.0f);

    // rotationZ[0].x = cos(-this->currentYRot);
    // rotationZ[0].y = -sin(-this->currentYRot);
    // rotationZ[1].x = sin(-this->currentYRot);
    // rotationZ[1].y = cos(-this->currentYRot);
    // rotationZ[2].z = 1;
    // rotationZ[3].w = 1;
    ...
    // this->shapes[0]->applyMatrix(this->Transpose(rotationY));
    // this->shapes[0]->applyMatrix(this->Transpose(rotationZ));
    // this->shapes[0]->applyMatrix(this->Transpose(rotationX));

    // this->shapes[1]->applyMatrix(this->Transpose(rotationY));
    // this->shapes[1]->applyMatrix(this->Transpose(rotationZ));
    // this->shapes[1]->applyMatrix(this->Transpose(rotationX));

    // rotationZ[0].x = cos(tempZ);
    // rotationZ[0].y = -sin(tempZ);
    // rotationZ[1].x = sin(tempZ);
    // rotationZ[1].y = cos(tempZ);
    // rotationZ[2].z = 1;
    // rotationZ[3].w = 1;

    // rotationY[0].x = cos(tempY);
    // rotationY[0].z = -sin(tempY);
    // rotationY[1].y = 1;
    // rotationY[2].x = sin(tempY);
    // rotationY[2].z = cos(tempY);
    // rotationY[3].w = 1;
