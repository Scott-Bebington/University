...
vec4 Shape::multiplyMatrixVector(mat4x4 m, vec4 v)
{
    vec4 result;
...
vec4 Shape::multiplyColourVector(vec4 v, float f)
{
...
Pyramid::Pyramid(vec3 *vertices, vec4 color)
{
...
Halfbox::Halfbox(vec3 center, double height, double width, double length, vec4 color, string direction)
{
...
void Halfbox::halfboxBottomLeft(vec3 center, double height, double width, double length, vec4 color)
{
...
void Halfbox::halfboxBottomRight(vec3 center, double height, double width, double length, vec4 color)
{
...
void Halfbox::halfboxTopLeft(vec3 center, double height, double width, double length, vec4 color)
{
...
void Halfbox::halfboxTopRight(vec3 center, double height, double width, double length, vec4 color)
{
...
void Halfbox::halfboxTopFront(vec3 center, double height, double width, double length, vec4 color)
{
...
void Halfbox::halfboxTopBack(vec3 center, double height, double width, double length, vec4 color)
{
...
void Halfbox::halfboxBottomFront(vec3 center, double height, double width, double length, vec4 color)
{
...
void Halfbox::halfboxBottomBack(vec3 center, double height, double width, double length, vec4 color)
{
    vec3 nearLeftTop = this->addVectors(nearPlane, leftPlane, topPlane);
    vec3 nearRightTop = this->addVectors(nearPlane, rightPlane, topPlane);
    vec3 nearLeftBottom = this->addVectors(nearPlane, leftPlane, bottomPlane);
...
Cone::Cone(vec3 center, int numSidesOnBase, float height, float radius, vec4 color)
{
...
void Cylinder::Circles(vec3 center, int numSidesOnBase, float height, float radius, vec4 color)
{
    // -------------------------------------------------- //
    // Drawing the Back face of the cylinder
    // -------------------------------------------------- //
