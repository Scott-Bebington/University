...
encryptString:
    ...
    EncryptLoop:
        ...
        cmp r12, r15               ; Compare r12 (Keyword position counter) to r15 (Keyword Length)
        jmp EncryptLoop
