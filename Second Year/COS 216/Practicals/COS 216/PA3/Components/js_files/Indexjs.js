...
function ApiRequest(make, model, price, callback) 
{
    ...
    xhttp.onload = function () {
        ...
        const card = generateCarCard(
            ...
            random.data[0].number_of_seats, price, random.data[0].image);
        callback(card);
...
function generateCarCard(make, model, year, bodytype, fuel, transmission, seats, price, image) {
    ...
    <div class="CarOutline"><div class="Photo" style="background-image: URL(${image});"></div>
    <div class="Info">
        <h1>
            ${year} ${make} ${model}
        </h1>
